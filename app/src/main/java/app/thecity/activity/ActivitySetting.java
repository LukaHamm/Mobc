 ...
 * Die Klasse ActivitySetting ist eine Android-Aktivität (PreferenceActivity),
 * die die App-Einstellungen und Benachrichtigungseinstellungen anzeigt und verwaltet
 */
public class ActivitySetting extends PreferenceActivity {
    ...
    /*
      Diese Methode wird aufgerufen, wenn die Aktivität erstellt wird. Sie lädt die Einstellungen
      aus der XML-Ressource setting_notification.xml, initialisiert die Toolbar und bindet die
      Zusammenfassungen der Einstellungen an ihre Werte.
     */
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Preference devPref = (Preference) findPreference("key_dev");
        ...
        resetCachePref.setOnPreferenceClickListener(preference -> {
        ...
        devPref.setOnPreferenceClickListener(preference -> {
            Tools.directLinkToBrowser(ActivitySetting.this, String.valueOf(AppConfig.general));
            return false;
        });
    ...
    // Die Methode initToolbar() wird aufgerufen, um die Toolbar zu initialisieren.
    @Override
    ...
    // Öffnet einen Dialog, der die Nutzungsbedingungen anzeigt.
    ...
    // Öffnet einen Dialog, der es dem Benutzer ermöglicht, die App-Farbe auszuwählen
     ...
     * Bindet eine Zusammenfassung zu einer Einstellung, die angibt, dass sich die Zusammenfassung
     * automatisch aktualisiert, wenn sich der Wert der Einstellung ändert
     */
     ...
     * Ein Listener, der die Zusammenfassung einer Einstellung aktualisiert, wenn sich der Wert ändert.
     */
    ...
    // Wird nach der Erstellung der Aktivität aufgerufen
    @Override
    ...
    // Initialisiert die Toolbar und konfiguriert die Systemleiste für Lollipop
    ...
    /*
      Reagiert auf Klicks auf die Menüelemente, insbesondere auf die Zurück-Schaltfläche in der
      Aktionsleiste, um zur vorherigen Aktivität zurückzukehren
     */
    @Override
    ...
    /*
      Implementierungen von Methoden, die die Kompatibilität mit älteren Android-Versionen
      sicherstellen, indem sie auf die entsprechenden Methoden in AppCompatDelegate verweisen
     */
    ...
    /*
      Methoden, die das Verhalten der Aktivität verwalten und die Delegiertenfunktionen
      von AppCompatDelegate aufrufen
     */
    @Override
